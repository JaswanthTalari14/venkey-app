...
<div class="dashboard-layout">
    <aside class="sidebar glass-panel">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="doctor_medicines.php" class="active"><i class="fas fa-pills"></i> Manage Medicines</a></li>
    ...
    <main class="dashboard-content">
        ...
        <p style="color: var(--text-secondary); margin-bottom: 2rem;">Add new tablets or update existing medical supplies for patients to order.</p>
